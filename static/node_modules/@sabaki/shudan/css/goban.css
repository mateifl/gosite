.shudan-goban {
    ...
    .shudan-goban-image {
        background: url('/static/game/img/goban/board.png') var(--shudan-board-background-color);
}
...
.shudan-vertex .shudan-stone {
    ...
    .shudan-stone-image.shudan-sign_1 {
        background-image: url('/static/game/img/goban/stone_1.png');
    }
    .shudan-stone-image.shudan-sign_-1 {
        background-image: url('/static/game/img/goban/stone_-1.png');
}
